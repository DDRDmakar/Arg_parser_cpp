...
std::vector<std::string> Arg_parser::get_all_args(void) { return all_args; }
std::string Arg_parser::get_arg(const unsigned int index)
{
	try { return all_args.at(index); }
	catch (std::out_of_range) { return ""; }
}
std::string Arg_parser::get_all_args_line(void) { return full_text; }
std::string Arg_parser::get_first_args_line(const unsigned int to_index)
{
	std::stringstream ss;
...
std::string Arg_parser::get_last_args_line(const unsigned int from_index)
{
	std::stringstream ss;
